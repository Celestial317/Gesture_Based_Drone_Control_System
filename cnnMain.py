...
def load_dataset(dataset_path):
    ...
    for file in os.listdir(dataset_path):
        if file.endswith(".jpg") or file.endswith(".png"):
            ...
            label = int(file.split("_")[1])  # Assuming labels are encoded in filenames
...
while True:
    ...
    # Assume hand detection and splitting are implemented
    left_hand_frame = frame[:, :frame.shape[1]//2]  # Placeholder for actual hand detection logic
